...
I did the Git and Github lab, which was a small interactive exercise to practice the Git workflow. The staging step did confuse me at first (why I had to __add__ before I can __commit__) but after messing around with it for a while, it clicked in my head.
